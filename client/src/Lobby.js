        ...
        <section className="horizontal-flex">
            ...
            <div className="lobby-admin">
                <div className="horizontal-flex lobby-info">
                    <div className="vertical-flex lobby-about-code">
                        Room Code<span>{admin?.code}</span>
                    </div>
                    <div className="vertical-flex lobby-about-mode">
                ...
                <div className="player-settings">
                    <div className="vertical-flex lobby-admin-playerLimit">
                        ...
                        <Slider
                            ...
                            max="4"
                            step="1"
                            value={admin.playerLimit}
                            onChange={changePlayerLimit}
                        />
                    </div>
                    <Checkbox
                        className="lobby-admin-playerSettingsAuth"
                        name="playerSettingsAuth"
                        description="Allow players to modify settings"
                        checked={admin.playerSettingsAuth}
                        onChange={changePlayerAuth}
                    />
                </div>
            </div>
        </section>
        ...
        <section className="lobby-settings">
                    ...
                    {settings?.avaliableTests?.map?.((test, i) => {
                        return (
                            <Checkbox
                                ...
                                description={test}
                                checked={settings.tests[i]}
                                onChange={(checked) => changeTests(i, checked)}
                            />
                        );
                    })}
                </div>
            ...
            <div className="lobby-settings-panel">
                ...
                <div className="lobby-exam-settings">
                    <Checkbox
                        name="lobby-exam-sort"
                        description="Sort problems by difficulty"
                        checked={settings.sortExam}
                        onChange={changeSortExam}
                    />
                </div>
            </div>
        </section>
        ...
        <section className="lobby">
            <section className="lobby-header">
                <img
                    ...
                    src="assets/vo_svg_logo_horizontal.svg"
                    alt="Virtual Olympiad"
                />
                <div className="lobby-icons">
                    <a
                        href="https://github.com/polarr/virtual-olympiad"
                        target="_blank"
                    >
                    ...
                    <a
                        href="https://github.com/polarr/virtual-olympiad/wiki/Guide"
                        target="_blank"
                    >
